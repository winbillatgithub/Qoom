...
public:
	...
	BOOL InsertXItem(int nItem, LPCTSTR lpszItem, int nImage);
	...
	void SetInfoColor(COLORREF cr);
	void SetInfoColorFlag(bool bInfo, int iIndex, COLORREF cr);
...
protected:
	...
	CArray<BOOL, BOOL> m_arrayInfoTab; //** enabled Y\N
	int m_iSelectedTab;
	POINT m_ptTabs;
